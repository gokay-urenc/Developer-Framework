...
namespace DevFramework.Core.Aspects.Postsharp.CacheAspects
{
    ...
    public class CacheRemoveAspect : OnMethodBoundaryAspect
    {
        ...
        public CacheRemoveAspect(Type cacheType) => _cacheType = cacheType;
        ...
        public override void OnSuccess(MethodExecutionArgs args) => _cacheManager.RemoveByPattern(string.IsNullOrEmpty(_pattern)
